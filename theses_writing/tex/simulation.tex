...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.6\textwidth]{images/km_ggkm_melanoma_em.png}
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\caption{Resultados do IBS médio, C-index médio e respectivos desvios padrão para cada kernel no conjunto de dados Melanoma.}
...
\multirow{2}{*}{\shortstack[c]{Binomial Negativa\\com $\phi$ estimado}}
& IBS
& 0.1573
& 0.1544
& 0.1548
