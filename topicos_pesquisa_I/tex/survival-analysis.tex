...
Saber se um evento de interesse ocorrerá ou não é crucial. No entanto, em diversos cenários, saber quando
ele ocorrerá pode ser ainda mais importante. Nesse contexto, surge uma metodologia estatística denominada
análise de sobrevivência. O tempo transcorrido até a ocorrência de um evento de interesse é denominado
tempo de sobrevivência \cite{aalen2008survival}. Por exemplo, em um estudo cujo interesse seja a inadimplência de associados de uma cooperativa de crédito,
o tempo de sobrevivência pode ser definido como o tempo até a ocorrência da inadimplência. Assim sendo, a
análise de sobrevivência tem como objetivo modelar a distribuição desse tempo e investigar fatores que possam
influenciar sua ocorrência. Portanto, este capítulo terá como objetivo apresentar conceitos que fundamentam a
análise de sobrevivência.

\section{Censura}

A principal característica que distingue a análise de sobrevivência de outras áreas da estatística é a
presença de censura nos dados. Por exemplo, considere que os associados de uma cooperativa de crédito
estejam sendo acompanhados ao longo do tempo para analisar a ocorrência de inadimplência. Nesse contexto,
duas situações podem ocorrer. Alguns associados podem se tornar inadimplentes durante o período de
acompanhamento, enquanto outros podem não experimentar o evento até o término do estudo. Neste último caso,
ocorre censura, pois o tempo de sobrevivência desses indivíduos não é observado completamente, mas é conhecido
que o evento ocorrerá após um determinado instante de tempo.
% mas sabe-se
% apenas que o evento ocorrerá após um determinado instante de tempo.
% Portanto, a censura ocorre quando o
% tempo de sobrevivência não é observado de forma exata \cite{moore2016applied}.


A censura pode ocorrer de três formas diferentes. O exemplo dado anteriormente pode ser entendido como sendo
uma censura à direita. A censura à direita ocorre quando o evento ocorreu depois de um determinado tempo, mas o tempo
exato não é conhecido. Outro tipo de censura é a censura à esquerda, que ocorre quando o evento ocorreu antes de um determinado
tempo. Ainda no caso da inadimplência, um exemplo de censura à esquerda seria quando um associado já se
encontrava inadimplente no início do estudo, mas o tempo exato de ocorrência da inadimplência não é
conhecido. Por fim, a censura intervalar ocorre quando o evento ocorreu dentro de um intervalo de tempo,
mas o tempo exato não é conhecido. No exemplo da inadimplência, a censura intervalar poderia ocorrer se os
associados fossem avaliados periodicamente, e o evento de inadimplência fosse detectado apenas durante
essas avaliações, sem que o tempo exato de ocorrência fosse conhecido.
