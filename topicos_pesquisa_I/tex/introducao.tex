...
O objetivo deste trabalho é apresentar os fundamentos teóricos e os principais resultados relacionados
à proposta de uma extensão do modelo de tempo de promoção, de modo que seja possível a incorporação de funções
kernel na modelagem da fração de cura.

% possibilitar a incorporação de funções
% kernel na modelagem da fração de cura.

\section{Organização do Trabalho}

Este trabalho está estruturado da seguinte forma. No Capítulo 2 são apresentados fundamentos de análise de sobrevivência,
incluindo noções de censura, funções de sobrevivência, modelo de Cox, além de descrever brevemente modelos com
fração de cura. No Capítulo 3, são introduzidos alguns conceitos que fundamentam métodos baseados em kernel. Dessa forma,
são apresentadas definições como espaços de Hilbert, kernels positivos definidos e alguns kernels principais.

No Capítulo 4, é detalhada a metodologia adotada, abrangendo os recursos computacionais utilizados,
particionamento dos dados, a geração de dados simulados com fração de cura. O Capítulo 5 apresenta
e discute os resultados obtidos tanto em dados simulados quanto em dados reais. Por fim, o Capítulo 6
