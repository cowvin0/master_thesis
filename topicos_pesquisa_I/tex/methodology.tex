...
Essa especificação implica que os tempos latentes seguem uma distribuição Weibull com parâmetro de forma
$\alpha$ e parâmetro de escala $\lambda(\mathbf{x}) = \left\{\exp(\beta_1x_1+\beta_2x_2)\right\}^{-1/\alpha}$.
