...
\caption{Resultados do IBS médio, C-index médio, AUC médio e respectivos desvios padrão para o modelo GG-KM com abordagem de boosting no conjunto de dados Melanoma.}
\label{tab:melanoma_boosting}
